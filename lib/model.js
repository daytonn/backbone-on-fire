    ...
    options.toJSON = function() {
      ...
      _(this.relationships).each(function(relationshipClass, relationship) {
        ...
        if (this.get(relationship).models) {
          attributes[relationship + "_attributes"] = this.get(relationship).models.map(function(model) {
            return _.clone(model.attributes);
          });
        } else {
          attributes[relationship + "_attributes"] = _.clone(this.get(relationship).attributes);
        }
      }, this);
