// TODO add name/root for JSON payloads
(function() {
  /**
    @static
    @method extend
  ...
  */
  Backbone.OnFire.Model = Backbone.Model.extend({
    ...
    */
    deserialize: function(json) {
      return processSerializer.call(this, "deserialize", json);
    },
    ...
    */
    serialize: function() {
      return processSerializer.call(this, "serialize", this.toJSON());
    },

    toJSON: function() {
      return processSerializer.call(this, "toJSON", _.clone(this.attributes));
    },
  ...
  function processSerializer(method, json) {
    var _this = this;
    return this.serializers.reduce(function(memo, serializer) {
      return serializer[method].call(_this, memo);
    }, json);
  }
